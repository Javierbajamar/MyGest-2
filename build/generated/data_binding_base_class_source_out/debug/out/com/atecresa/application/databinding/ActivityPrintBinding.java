...
public final class ActivityPrintBinding implements ViewBinding {
  ...
  private ActivityPrintBinding(@NonNull ConstraintLayout rootView, @NonNull Button BTPrint,
      @NonNull EditText editText2, @NonNull TextView textView, @NonNull TextView textView4,
  ...
  public static ActivityPrintBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPrintBinding((ConstraintLayout) rootView, BTPrint, editText2, textView,
          textView4, textView5);
    }
